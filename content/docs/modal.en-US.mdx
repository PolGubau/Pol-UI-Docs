...
<Example
  storybookUrl="https://pol-ui-storybook.vercel.app/?path=/story/components-modal--warning"
  height={400}
  name="Warning modal"
  code={warning}
  embedUrl="https://pol-ui-storybook.vercel.app/iframe.html?args=&id=components-modal--warning&viewMode=story"
>
  <WarningCode />
</Example>
...
<Example
  storybookUrl="https://pol-ui-storybook.vercel.app/?path=/story/components-modal--form"
  height={400}
  name="Modal with a form"
  code={form}
  embedUrl="https://pol-ui-storybook.vercel.app/iframe.html?args=&id=components-modal--form&viewMode=story"
>
  <FormCode />
</Example>
## Theme
