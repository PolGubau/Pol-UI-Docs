...
description: Use the timeline component from Pol-ui to display a list of items and events in a chronological order based on multiples styles, colors and layouts
---
...
You can customize the content and options of the timeline component by using the custom React props API from Pol-ui and the utility classes from Tailwind CSS for quick style changes.

In order to use the timeline component make sure to import it first from Pol-ui:
