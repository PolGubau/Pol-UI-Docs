...
name="Default banner"
code={root}
storybookUrl='breadcrumb--default'
embedUrl="breadcrumb--default&viewMode=story"
...
name="Custom classes"
code={classes}
storybookUrl='breadcrumb--solid-background'
embedUrl="breadcrumb--solid-background&viewMode=story"
