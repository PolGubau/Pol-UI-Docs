...
name="Default banner"
code={root}
storybookUrl="banner--default-banner"
embedUrl="banner--default-banner&viewMode=story"
...
<Example
  height={480}
name="All colors"
storybookUrl="banner--all-colors"
code={Colors}
embedUrl="banner--all-colors&viewMode=story"
...
code={ColorsDark}
storybookUrl="banner--all-colors-dark-mode"
embedUrl="banner--all-colors-dark-mode&viewMode=story"
...
code={Rounded}storybookUrl="banner--all-rounded"

embedUrl="banner--all-rounded&viewMode=story"
