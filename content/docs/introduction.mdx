...
<div className="flex w-full mb-16">
  <BigLink slug="/projects/nuwe" name="Check what I did in Nuwe" />
</div>
...
<div className="flex w-full mb-16">
  <BigLink slug="/projects/uabmedia" name="Check UAB Mèdia project" />
</div>
...
<div className="flex w-full mb-16">
  <BigLink slug="/projects/mesalvo" name="Check Mesalvo project" />
</div>
...
<BigLink slug="/projects/polui" name="Check the Pol/UI Thesis" />
