...
<Example
  storybookUrl="progress--default"
  height={250}
  name="Default Progress"
  code={root}
  embedUrl="progress--default&viewMode=story"
>
  <RootCode />
</Example>
...
<Example
  storybookUrl="progress--roundness"
  height={400}
  name="All rounded sizes"
  code={roundness}
  embedUrl="progress--roundness&viewMode=story"
>
  <RoundnessCode />
</Example>
### All sizes
...
<Example
  storybookUrl="progress--sizes"
  height={400}
  name="All sizes"
  code={allSizes}
  embedUrl="progress--sizes&viewMode=story"
>
  <AllSizesCode />
</Example>
...
<Example
  storybookUrl="progress--all-colors"
  height={400}
  name="All colors"
  code={allColors}
  embedUrl="progress--all-colors&viewMode=story"
>
  <AllColorsCode />
</Example>
...
<Example
  storybookUrl="progress--custom-class-names"
  height={400}
  name="All colors"
  code={customClasses}
  embedUrl="progress--custom-class-names&viewMode=story"
>
  <CustomClassesCode />
</Example>
...
<Example
  storybookUrl="progress--without-motion"
  height={400}
  name="Progress without motion"
  code={withoutMotion}
  embedUrl="progress--without-motion&viewMode=story"
>
  <WithoutMotionCode />
</Example>
