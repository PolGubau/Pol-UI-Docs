...
| --------------- | ------------------- |
| npm             | npm install pol-ui  |
| pnpm            | pnpm install pol-ui |
| yarn            | yarn add pol-ui     |
...
```bash title="bash - Installing Tailwind CSS" showLineNumbers
npm install -D tailwindcss postcss autoprefixer
npx tailwindcss init -p
```

We recommend following the [official documentation](https://tailwindcss.com/docs/installation).
