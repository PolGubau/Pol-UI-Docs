...
description: Get started with the tabs component from Pol-ui to show a list of tab items where you can switch between them using multiple styles, colors and layouts
---
