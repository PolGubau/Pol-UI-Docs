...
description: Get started with the rating component from Pol-ui to show testimonials and user reviews of your products using stars, labels and advanced layouts
---
